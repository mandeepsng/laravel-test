            ...
            <section class="py-lg-7 py-5 bg-light-subtle">
               <div class="container">
                  <div class="row">
                    ...
                    @if(Route::is(['home', 'users.index', 'roles.index', 'permissions.index', 'stripe.index', 'account-profile' , 'admin.home', 'stripe.create', 'blog.create', 'blog.index', 'blog.edit', 'user.profile.edit' ]))
