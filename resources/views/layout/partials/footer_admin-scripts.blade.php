          ...
          <div class="col-md-3">
             <div class="text-md-end d-flex align-items-center justify-content-md-end">
                ...
                <div class="ms-3 d-flex gap-2">
                   <a href="https://www.instagram.com/yoblogger/" class="text-reset btn btn-instagram btn-icon">
                   ...
                   <a href="https://x.com/mandeepsng7" class="text-reset btn btn-twitter btn-icon">
...
<script src="{{ asset('assets/libs/cleave.js/dist/addons/cleave-phone.i18n.js')}}"></script>
