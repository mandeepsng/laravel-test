...
@section('content')
   ...
   <div class="col-lg-9 col-md-8">
      <div class="mb-4">
         <h1 class="mb-0 h3"> Add Permission </h1>
      </div>
      ...
      <div class="card border-0 shadow-sm mb-4">
         <div class="card-body p-lg-5">
            <div class="mb-5">
               ...
               <p class="mb-0 fs-6">Add new permission details.</p>
            </div>

            {!! Form::open(array('route' => 'permissions.store','method'=>'POST')) !!}
            {{-- <form class="row g-3 needs-validation" novalidate action="{{ route('permissions.store') }}" method="POST"> --}}
               @csrf
