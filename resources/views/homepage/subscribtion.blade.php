...
<section class="my-xl-7 py-5">
    <div class="container pb-lg-5">
        <div class="flex flex-col items-center">
            <h2 class="inline text-4xl font-semibold"> Save weeks of development for every new laravel project </h2>
            <p class="max-w-4xl mt-4 text-lg sm:text-center"> Larafast is a powerful Laravel Starter Kit that allows developers to create web applications quickly and efficiently. </p>
        </div>
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 offset-lg-1 col-md-6 col-12 order-lg-2" data-cue="slideInRight">
                <div class="mt-md-5">
                    ...
                    <div class="mb-5 mt-4">
                        <h2 class="mb-3">Subscriptions & One Time Payments</h2>
                        <p class="lead mb-0">Manage both recurring and single transactions seamlessly. Handle subscriptions, process one-time payments, access the customer billing portal, integrate webhooks for real-time updates, and view the order and subscription statistics.</p>
                    </div>
